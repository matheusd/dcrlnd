...
func testChanRestoreScenario(t *harnessTest, net *lntest.NetworkHarness,
	...
	carol.LogPrintf("=========== gonna suspend carol")
	// time.Sleep(sweep.DefaultBatchWindowDuration)
...
func createLegacyRevocationChannel(net *lntest.NetworkHarness, t *harnessTest,
	chanAmt, pushAmt dcrutil.Amount, from, to *lntest.HarnessNode) {

	t.Skipf("Test disabled until support for PSBTs is added")
