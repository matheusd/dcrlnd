...
func (c *mppTestContext) openChannel(from, to *lntest.HarnessNode, chanSize dcrutil.Amount) {
	ctxb := context.Background()
...
func (c *mppTestContext) buildRoute(ctxb context.Context, amt dcrutil.Amount,
