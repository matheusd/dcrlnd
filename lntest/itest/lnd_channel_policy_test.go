...
func testUpdateChannelPolicyFeeRateAccuracy(net *lntest.NetworkHarness,
	...
	expectedFeeRateMilliMAtoms := int64(math.Round(testFeeBase * feeRate))

	expectedPolicy := &lnrpc.RoutingPolicy{
		FeeBaseMAtoms:      baseFee,
		FeeRateMilliMAtoms: expectedFeeRateMilliMAtoms,
		TimeLockDelta:      timeLockDelta,
		MinHtlc:            defaultMinHtlc,
		MaxHtlcMAtoms:      maxHtlc,
	}
	...
	expectedPolicy.FeeRateMilliMAtoms = int64(feeRatePPM)
