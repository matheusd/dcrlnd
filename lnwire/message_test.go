...
func newMsgOpenChannel(t testing.TB, r *rand.Rand) *lnwire.OpenChannel {
	...
	msg := &lnwire.OpenChannel{
		...
		PushAmount:           lnwire.MilliAtom(r.Int63()),
		DustLimit:            dcrutil.Amount(r.Int63()),
		MaxValueInFlight:     lnwire.MilliAtom(r.Int63()),
		ChannelReserve:       dcrutil.Amount(r.Int63()),
		HtlcMinimum:          lnwire.MilliAtom(r.Int63()),
		FeePerKiloByte:       uint32(r.Int31()),
...
func newMsgUpdateAddHTLC(t testing.TB, r *rand.Rand) *lnwire.UpdateAddHTLC {
	...
	msg := &lnwire.UpdateAddHTLC{
		ID:        r.Uint64(),
		Amount:    lnwire.MilliAtom(r.Int63()),
		Expiry:    r.Uint32(),
		ExtraData: createExtraData(t, r),
	}
...
func newMsgChannelAnnouncement(t testing.TB,
	...
	msg := &lnwire.ChannelAnnouncement{
		...
		DecredKey1:      randRawKey(t),
		DecredKey2:      randRawKey(t),
		ExtraOpaqueData: createExtraData(t, r),
		NodeSig1:        testNodeSig,
		NodeSig2:        testNodeSig,
		DecredSig1:      testNodeSig,
		DecredSig2:      testNodeSig,
	}
...
func newMsgChannelUpdate(t testing.TB, r *rand.Rand) *lnwire.ChannelUpdate {
	...
	maxHtlc := lnwire.MilliAtom(r.Int63())
	...
	msg := &lnwire.ChannelUpdate{
		...
		HtlcMinimumMAtoms: lnwire.MilliAtom(r.Int63()),
		HtlcMaximumMAtoms: maxHtlc,
...
func randPubKey(t testing.TB) *secp256k1.PublicKey {
	t.Helper()
