...
func (cmd *compacter) compact(dst, src *bolt.DB) error {
...
// finds.
func (cmd *compacter) walk(db *bolt.DB, walkFn walkFunc) error {
...
func (cmd *compacter) walkBucket(b *bolt.Bucket, keyPath [][]byte, k, v []byte,
