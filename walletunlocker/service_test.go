...
func openOrCreateTestMacStore(tempDir string, pw *[]byte,
	...
	netDir := dcrwallet.NetworkDir(tempDir, netParams)
...
func TestGenSeed(t *testing.T) {
	...
	service := walletunlocker.New(
		testDir, testNetParams, nil, kvdb.DefaultDBTimeout,
		"", "", "", "", 0,
	)
...
func TestChangeWalletPasswordNewRootkey(t *testing.T) {
	...
	service := walletunlocker.New(
		testDir, testNetParams, tempFiles, kvdb.DefaultDBTimeout,
		"", "", "", "", 0,
	)
