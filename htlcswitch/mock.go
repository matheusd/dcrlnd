...
func (f *mockChannelLink) CheckHtlcForward([32]byte, lnwire.MilliAtom,
	lnwire.MilliAtom, uint32, uint32, uint32) *LinkError {
...
func (f *mockChannelLink) MayAddOutgoingHtlc(lnwire.MilliAtom) error    { return nil }
