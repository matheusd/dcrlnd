...
const (
	...
	//
	// The value 4032 corresponds to on average two weeks worth of blocks
	// and is based on the maximum number of hops (20), the default CLTV
	// delta (80), and some extra margin to account for the other lightning
	// implementations and past lnd versions which used to have a default
	// CLTV delta of 144.
	DefaultMaxOutgoingCltvExpiry = 4032
...
func (l *channelLink) sampleNetworkFee() (chainfee.AtomPerKByte, error) {
	// We'll first query for the atoms/kB recommended to be confirmed
	// within 3 blocks.
...
func shouldAdjustCommitFee(netFee, chanFee,
	minRelayFee chainfee.AtomPerKByte) bool {
...
func (l *channelLink) htlcManager() {
	...
	for {
		...
		case <-l.updateFeeTimer.C:
			...
			minRelayFee := l.cfg.FeeEstimator.RelayFeePerKB()
...
func getResolutionFailure(resolution *invoices.HtlcFailResolution,
	amount lnwire.MilliAtom) *LinkError {
...
func (l *channelLink) handleUpstreamMsg(msg lnwire.Message) {
	...
	case *lnwire.UpdateFee:
		...
		fee := chainfee.AtomPerKByte(msg.FeePerKB)
...
func (l *channelLink) MayAddOutgoingHtlc(amt lnwire.MilliAtom) error {
...
func (l *channelLink) getDustSum(remote bool) lnwire.MilliAtom {
...
//
// NOTE: Part of the dustHandler interface.
func (l *channelLink) getFeeRate() chainfee.AtomPerKByte {
...
// satisfy the current channel policy.  Otherwise, a LinkError with a valid
// protocol failure message should be returned in order to signal the
// violation. This call is intended to be used for locally initiated payments
// for which there is no corresponding incoming htlc.
...
func (l *channelLink) canSendHtlc(policy ForwardingPolicy,
	payHash [32]byte, amt lnwire.MilliAtom, timeout uint32,
	heightNow uint32) *LinkError {
...
func (l *channelLink) updateChannelFee(feePerKB chainfee.AtomPerKByte) error {
