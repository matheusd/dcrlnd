...
type ChanClose struct {
	...
	TargetFeePerKB chainfee.AtomPerKByte
...
func (s *Switch) CloseLink(chanPoint *wire.OutPoint,
	closeType contractcourt.ChannelCloseType, targetFeePerKB chainfee.AtomPerKByte,
...
func (s *Switch) evaluateDustThreshold(link ChannelLink,
	amount lnwire.MilliAtom, incoming bool) bool {
	...
	isLocalDust := isDust(feeRate, incoming, true, amount.ToAtoms())
	isRemoteDust := isDust(feeRate, incoming, false, amount.ToAtoms())
