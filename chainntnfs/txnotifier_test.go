...
var (
	testRawScript = []byte{
		...
		0x14,
		// <20-byte script hash>
		0x04, 0xb2, 0xdc, 0xc1, 0x14, 0xbf, 0xd3, 0xe1,
		0xab, 0x15, 0xfe, 0x5e, 0x54, 0xcd, 0x40, 0x6f,
		0xa4, 0x6d, 0xb9, 0x1a,
		// OP_EQUAL
		0x87,
	}
...
// TestTxNotifierRegistrationValidation ensures that we are not able to
// register requests with invalid parameters.
...
func TestTxNotifierNtfnDone(t *testing.T) {
	...
	spendTx := newWireTxWithVersion(1)
	spendTx.AddTxIn(&wire.TxIn{
