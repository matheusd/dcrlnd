...
func (h *clientDBHarness) removeTower(pubKey *secp256k1.PublicKey, addr net.Addr,
...
func (h *clientDBHarness) loadTower(pubKey *secp256k1.PublicKey, expErr error) *wtdb.Tower {
	h.t.Helper()
