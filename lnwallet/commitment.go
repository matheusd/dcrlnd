...
func CommitScriptToSelf(selfKey, revokeKey *secp256k1.PublicKey, csvDelay uint32) (
	*ScriptInfo, error) {
...
func CommitScriptToRemote(chanType channeldb.ChannelType,
	key *secp256k1.PublicKey) (*ScriptInfo, uint32, error) {
	...
	// Since this is a regular P2PKH, the WitnessScipt and PkScript should
