...
type LightningChannel struct {
	...
	// initiated.
	pendingAckFeeUpdate *AtomPerKByte
...
func (lc *LightningChannel) getSignedCommitTx() (*wire.MsgTx, error) {
	...
	sigScript, err := WitnessStackToSigScript(witness)
	if err != nil {
		return nil, err
	}
...
func newOutgoingHtlcResolution(signer Signer, localChanCfg *channeldb.ChannelConfig,
	...
	sigScript, err := WitnessStackToSigScript(timeoutWitness)
	if err != nil {
		return nil, err
	}
