...
type CommitmentKeyRing struct {
	...
	// base point secret. This may be included in a input.SignDescriptor to
	...
	NoDelayKey *secp256k1.PublicKey
...
func DeriveCommitmentKeys(commitPoint *secp256k1.PublicKey,
	...
	var (
		...
		noDelayBasePoint    *secp256k1.PublicKey
...
func NewBreachRetribution(chanState *channeldb.OpenChannel, stateNum uint64,
	...
	remoteWitnessHash, err := input.ScriptHashPkScript(remotePkScript)
	if err != nil {
		return nil, err
	}
...
func (lc *LightningChannel) createCommitmentTx(c *commitment,
	...
	switch {
	case lc.channelState.IsInitiator && commitFee > ourBalance.ToAtoms():
		ourBalance = 0
...
func (lc *LightningChannel) addHTLC(commitTx *wire.MsgTx, ourCommit bool,
	...
	amountPending := int64(paymentDesc.Amount.ToAtoms())
