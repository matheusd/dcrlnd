...
func TestDetermineFeePerKw(t *testing.T) {
	...
	// properly
	feeEstimator.blocksToFee[50] = 30000
	feeEstimator.blocksToFee[defaultNumBlocksEstimate] = 20000
	...
	for i, testCase := range testCases {
		targetFee, err := DetermineFeePerKB(
...
var sweepScript = []byte{
	0x76, 0xa9, 0x14, 0x3d, 0x8b, 0x15, 0x69, 0x4a, 0x54,
...
var testUtxos = []*lnwallet.Utxo{
	...
	{
		// Another p2pkh output.
		PkScript: []byte{
			0x76, 0xa9, 0x14, 0x17, 0xf7, 0xd1, 0x5f, 0x6f, 0x8b,
	...
	// A p2wsh output. The sweeper shouldn't (currently) know how to spend
