...
import (
	...
	secpv3 "github.com/decred/dcrd/dcrec/secp256k1/v3"
...
func PubKey3to2(key *secpv3.PublicKey) *secpv2.PublicKey {
	return &secpv2.PublicKey{
		X:     key.X(),
		Y:     key.Y(),
		Curve: secpv2.S256(),
	}
...
func PrivKey2to3(key *secpv2.PrivateKey) *secpv3.PrivateKey {
	return secpv3.PrivKeyFromBytes(key.Serialize())
}
