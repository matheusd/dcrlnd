...
func (ChannelCloseSummary_ClosureType) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{38, 0}
}
...
func (Peer_SyncType) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{42, 0}
}
...
func (PendingChannelsResponse_ForceClosedChannel_AnchorState) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 5, 0}
}
...
func (Invoice_InvoiceState) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{119, 0}
}
...
func (Payment_PaymentStatus) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{127, 0}
}
...
type ChannelAcceptResponse struct {
	...
	// The reserve amount in atoms that we require the remote peer to adhere to.
	// We require that the remote peer always have some reserve amount allocated to
	// them so that there is always a disincentive to broadcast old state (if they
	// hold 0 sats on their side of the channel, there is nothing to lose).
	ReserveAtoms uint64 `protobuf:"varint,6,opt,name=reserve_atoms,json=reserveAtoms,proto3" json:"reserve_atoms,omitempty"`
	// The maximum amount of funds in milliatoms that we allow the remote peer
	// to have in outstanding htlcs.
	InFlightMaxMatoms uint64 `protobuf:"varint,7,opt,name=in_flight_max_matoms,json=inFlightMaxMatoms,proto3" json:"in_flight_max_matoms,omitempty"`
	...
	// The minimum value in milliatoms for incoming htlcs on the channel.
...
func (x *ChannelAcceptResponse) GetReserveAtoms() uint64 {
	if x != nil {
		return x.ReserveAtoms
	}
	return 0
}

func (x *ChannelAcceptResponse) GetInFlightMaxMatoms() uint64 {
	if x != nil {
		return x.InFlightMaxMatoms
	}
	return 0
}
...
func (x *SendManyRequest) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *SendCoinsRequest) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
type Channel struct {
	...
	// The total amount of time the remote peer has been online while NOT sending
	// a ChannelReestablish message.
	ChanReestablishWaitTimeMs int64 `protobuf:"varint,900,opt,name=chan_reestablish_wait_time_ms,json=chanReestablishWaitTimeMs,proto3" json:"chan_reestablish_wait_time_ms,omitempty"`
	// The short channel id represented as a string, to ease log parsing. This is
	// the same as chan_id, but returned directly in the string representation.
	ShortChanId string `protobuf:"bytes,901,opt,name=short_chan_id,json=shortChanId,proto3" json:"short_chan_id,omitempty"`
...
func (x *Channel) GetChanReestablishWaitTimeMs() int64 {
	if x != nil {
		return x.ChanReestablishWaitTimeMs
	}
	return 0
}

func (x *Channel) GetShortChanId() string {
	if x != nil {
		return x.ShortChanId
	}
	return ""
}
...
type ChannelCloseSummary struct {
	...
	// The short channel id represented as a string, to ease log parsing. This is
	// the same as chan_id, but returned directly in the string representation.
	ShortChanId string `protobuf:"bytes,900,opt,name=short_chan_id,json=shortChanId,proto3" json:"short_chan_id,omitempty"`
...
func (x *ChannelCloseSummary) GetShortChanId() string {
	if x != nil {
		return x.ShortChanId
	}
	return ""
...
type BatchOpenChannelRequest struct {
	...
	// confirmed by.
	TargetConf int32 `protobuf:"varint,2,opt,name=target_conf,json=targetConf,proto3" json:"target_conf,omitempty"`
	// A manual fee rate set in atoms/Byte that should be used when crafting the
	// funding transaction.
	AtomsPerByte int64 `protobuf:"varint,3,opt,name=atoms_per_byte,json=atomsPerByte,proto3" json:"atoms_per_byte,omitempty"`
	// The minimum number of confirmations each one of your outputs used for
...
func (x *BatchOpenChannelRequest) GetAtomsPerByte() int64 {
	if x != nil {
		return x.AtomsPerByte
	}
	return 0
...
type BatchOpenChannel struct {
	...
	// commitment state.
	PushAtoms int64 `protobuf:"varint,3,opt,name=push_atoms,json=pushAtoms,proto3" json:"push_atoms,omitempty"`
	// Whether this channel should be private, not announced to the greater
	// network.
	Private bool `protobuf:"varint,4,opt,name=private,proto3" json:"private,omitempty"`
	// The minimum value in milliatoms we will require for incoming HTLCs on
	// the channel.
	MinHtlcMAtoms int64 `protobuf:"varint,5,opt,name=min_htlc_m_atoms,json=minHtlcMAtoms,proto3" json:"min_htlc_m_atoms,omitempty"`
...
func (x *BatchOpenChannel) GetPushAtoms() int64 {
	if x != nil {
		return x.PushAtoms
	}
	return 0
...
func (x *BatchOpenChannel) GetMinHtlcMAtoms() int64 {
	if x != nil {
		return x.MinHtlcMAtoms
	}
	return 0
...
type Amount struct {
	...
	// Value denominated in atoms.
	Atoms uint64 `protobuf:"varint,1,opt,name=atoms,proto3" json:"atoms,omitempty"`
	// Value denominated in milli-atoms.
	Matoms uint64 `protobuf:"varint,2,opt,name=matoms,proto3" json:"matoms,omitempty"`
}
...
func (x *Amount) GetMatoms() uint64 {
	if x != nil {
		return x.Matoms
	}
	return 0
...
type ChannelBalanceResponse struct {
	...
	MaxInboundAmount int64 `protobuf:"varint,900,opt,name=max_inbound_amount,json=maxInboundAmount,proto3" json:"max_inbound_amount,omitempty"`
	// Maximum amount we can send across all our channels, after accounting for
	// required reserves.
	MaxOutboundAmount int64 `protobuf:"varint,901,opt,name=max_outbound_amount,json=maxOutboundAmount,proto3" json:"max_outbound_amount,omitempty"`
}
...
type QueryRoutesRequest struct {
	...
	// does not support the specified records, and error will be returned.
...
type EnforceNodePingRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The node pub key in hexadecimal format.
	PubKey string `protobuf:"bytes,1,opt,name=pub_key,json=pubKey,proto3" json:"pub_key,omitempty"`
}

func (x *EnforceNodePingRequest) Reset() {
	*x = EnforceNodePingRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *EnforceNodePingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnforceNodePingRequest) ProtoMessage() {}

func (x *EnforceNodePingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[99]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnforceNodePingRequest.ProtoReflect.Descriptor instead.
func (*EnforceNodePingRequest) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{99}
}

func (x *EnforceNodePingRequest) GetPubKey() string {
	if x != nil {
		return x.PubKey
	}
	return ""
...
type EnforceNodePingResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Roud Trip Time (RTT) in microseconds to the peer.
	PingTimeMicro int64 `protobuf:"varint,1,opt,name=ping_time_micro,json=pingTimeMicro,proto3" json:"ping_time_micro,omitempty"`
}

func (x *EnforceNodePingResponse) Reset() {
	*x = EnforceNodePingResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *EnforceNodePingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnforceNodePingResponse) ProtoMessage() {}

func (x *EnforceNodePingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[100]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnforceNodePingResponse.ProtoReflect.Descriptor instead.
func (*EnforceNodePingResponse) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{100}
}

func (x *EnforceNodePingResponse) GetPingTimeMicro() int64 {
	if x != nil {
		return x.PingTimeMicro
	}
	return 0
}
...
type InvoiceHTLC struct {
	...
	// The total amount of the mpp payment in milli-atoms.
...
type CalcPaymentStatsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CalcPaymentStatsRequest) Reset() {
	*x = CalcPaymentStatsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalcPaymentStatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalcPaymentStatsRequest) ProtoMessage() {}

func (x *CalcPaymentStatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[139]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalcPaymentStatsRequest.ProtoReflect.Descriptor instead.
func (*CalcPaymentStatsRequest) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{139}
}

type CalcPaymentStatsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	HtlcAttempts    uint64 `protobuf:"varint,4,opt,name=htlc_attempts,json=htlcAttempts,proto3" json:"htlc_attempts,omitempty"`
	HtlcFailed      uint64 `protobuf:"varint,5,opt,name=htlc_failed,json=htlcFailed,proto3" json:"htlc_failed,omitempty"`
	HtlcSettled     uint64 `protobuf:"varint,6,opt,name=htlc_settled,json=htlcSettled,proto3" json:"htlc_settled,omitempty"`
	OldDupePayments uint64 `protobuf:"varint,7,opt,name=old_dupe_payments,json=oldDupePayments,proto3" json:"old_dupe_payments,omitempty"`
}

func (x *CalcPaymentStatsResponse) Reset() {
	*x = CalcPaymentStatsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalcPaymentStatsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalcPaymentStatsResponse) ProtoMessage() {}

func (x *CalcPaymentStatsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[140]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalcPaymentStatsResponse.ProtoReflect.Descriptor instead.
func (*CalcPaymentStatsResponse) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{140}
}

func (x *CalcPaymentStatsResponse) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *CalcPaymentStatsResponse) GetFailed() uint64 {
	if x != nil {
		return x.Failed
	}
	return 0
...
func (x *CalcPaymentStatsResponse) GetSucceeded() uint64 {
	if x != nil {
		return x.Succeeded
	}
	return 0
...
func (x *CalcPaymentStatsResponse) GetHtlcAttempts() uint64 {
	if x != nil {
...
func (x *CalcPaymentStatsResponse) GetHtlcFailed() uint64 {
	if x != nil {
		return x.HtlcFailed
	}
	return 0
...
func (x *CalcPaymentStatsResponse) GetHtlcSettled() uint64 {
	if x != nil {
		return x.HtlcSettled
	}
	return 0
}

func (x *CalcPaymentStatsResponse) GetOldDupePayments() uint64 {
	if x != nil {
		return x.OldDupePayments
	}
	return 0
}
...
func (x *RPCMiddlewareResponse) GetRequestId() uint64 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (*PendingChannelsResponse_PendingChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 0}
}
...
func (x *PendingChannelsResponse_PendingChannel) GetShortChanId() string {
	if x != nil {
		return x.ShortChanId
	}
	return ""
...
func (*PendingChannelsResponse_PendingOpenChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 1}
}
...
func (*PendingChannelsResponse_WaitingCloseChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 2}
}
...
func (*PendingChannelsResponse_Commitments) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 3}
}
...
func (*PendingChannelsResponse_ClosedChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 4}
}
...
func (*PendingChannelsResponse_ForceClosedChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{77, 5}
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x22, 0x56, 0x0a, 0x18, 0x53, 0x65, 0x6e, 0x64,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x65, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x70, 0x65, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	0x22, 0x1b, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xea, 0x01,
	0x0a, 0x04, 0x55, 0x74, 0x78, 0x6f, 0x12, 0x35, 0x0a, 0x0c, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x6c,
	...
	0x74, 0x5f, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x61,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x74, 0x6f, 0x6d, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6b,
	...
	0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xc6, 0x02, 0x0a, 0x0b, 0x54,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x11, 0x6e,
	0x75, 0x6d, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x6e, 0x75, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x65, 0x6e, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12,
	0x18, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x4c, 0x0a, 0x12, 0x54, 0x72, 0x61,
	...
	,
	...
	0x67, 0x6f, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x04, 0x42, 0x02, 0x30, 0x01, 0x52, 0x0e, 0x6f, 0x75, 0x74, 0x67, 0x6f, 0x69, 0x6e,
	0x67, 0x43, 0x68, 0x61, 0x6e, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x17, 0x69, 0x67, 0x6e, 0x6f, 0x72,
	0x65, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x61,
	0x6d, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65,
	0x4d, 0x61, 0x78, 0x4f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x41, 0x6d, 0x74, 0x12, 0x26,
	...
	0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x0c, 0x20, 0x03,
	...
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x61, 0x6c,
	...
	0x10, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x65,
	...
	0x0a, 0x66, 0x65, 0x65, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x62, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x04, 0x52, 0
, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x6f, 0x72,
	0x12, 0x39, 0x0a, 0x0f, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x5f, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61,
	0x74, 0x6f, 0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x6c, 0x6e, 0x72, 0x70,
	0x63, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x0e, 0x63, 0x6c, 0x6f,
	0x73, 0x65, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x33, 0x0a, 0x0b, 0x72,
	0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x11, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74,
	...
	0x0a, 0x09, 0x41, 0x42, 0x41, 0x4e, 0x44, 0x4f, 0x4e, 0x45, 0x44, 0x10, 0x05, 0x22, 0xef, 0x01,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x50, 0x0a, 0x08, 0x53, 0x79, 0x6e, 0x63, 0x54, 0x79,
	...
	0x5f, 0x53, 0x59, 0x4e, 0x43, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x49, 0x4e, 0x4e, 0x45,
	0x44, 0x5f, 0x53, 0x59, 0x4e, 0x43, 0x10, 0x03, 0x22, 0x46, 0x0a, 0x10, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x1c, 0x0a, 0x09,
	...
	,
	...
	0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e,
	...
	0x50, 0x45, 0x45, 0x52, 0x5f, 0x4f, 0x4e, 0x4c, 0x49, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x10, 0x0a,
	0x0c, 0x50, 0x45, 0x45, 0x52, 0x5f, 0x4f, 0x46, 0x46, 0x4c, 0x49, 0x4e, 0x45, 0x10, 0x01, 0x22,
	0x10, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0x90, 0x07, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73,
	...
	0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x14,
	...
	0x69, 0x74, 0x79, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x51, 0x0a, 0x12,
	0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6c, 0x6f, 0x73, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x78,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x63, 0x6c, 0x6f, 0x73, 0x69, 0x6e,
	0x67, 0x54, 0x78, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22,
	0xdd, 0x01, 0x0a, 0x13, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	...
	0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x24, 0x0a, 0x0e, 0x61, 0x74, 0x6f, 0x6d,
	0x73, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0c, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x50, 0x65, 0x72, 0x42, 0x79, 0x74, 0x65, 0x12, 0x29,
	...
	0x72, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07, 0x22,
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x73, 0x62, 0x74, 0x22, 0xf5, 0x01, 0x0a, 0x17,
	...
	0x05, 0x52, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x24, 0x0a,
	0x0e, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x50, 0x65, 0x72, 0x42,
	...
	0x62, 0x65, 0x6c, 0x22, 0xfe, 0x02, 0x0a, 0x10, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x67, 0x53, 0x68, 0x69, 0x6d, 0x12, 0x48, 0x0a, 0x22, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x5f, 0x69, 0x6e, 0x5f, 0x66, 0x6c,
	0x69, 0x67, 0x68, 0x74, 0x5f, 0x6d, 0x5f, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x1c, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x4d, 0x61, 0x78, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x49, 0x6e, 0x46, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x4d, 0x41, 0x74, 0x6f, 0x6d, 0x73,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x4a, 0x04,
	0x08, 0x01, 0x10, 0x02, 0x22, 0xf3, 0x01, 0x0a, 0x10, 0x4f, 0x70, 0x65, 0x6e, 0x53, 0x74, 0x61,
	...
	0x65, 0x79, 0x4c, 0x6f, 0x63, 0x22, 0xf0, 0x01, 0x0a, 0x0d, 0x43, 0x68, 0x61, 0x6e, 0x50, 0x6f,
	...
	,
	...
	,
	...
	0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x6d, 0x61, 0x74, 0x75,
	...
	,
	...
	,
	...
	0x52, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x46, 0x65, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1c, 0x0a, 0x0a,
	0x66, 0x65, 0x65, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x62, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x66, 0x65, 0x65, 0x50, 0x65, 0x72, 0x4b, 0x62, 0x1a, 0xd1, 0x01, 0x0a, 0x13, 0x57,
	...
	,
	...
	0x52, 0x0b, 0x63, 0x6c, 0x6f, 0x73, 0x69, 0x6e, 0x67, 0x54, 0x78, 0x69, 0x64, 0x1a, 0xee, 0x03,
	0x0a, 0x12, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x43, 0x68, 0x61,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0
 0x74, 0x61, 0x12, 0x2f, 0x0a, 0x14, 0x68, 0x74, 0x6c, 0x63, 0x5f, 0x6d, 0x69, 0x6e,
	0x69, 0x6d, 0x75, 0x6d, 0x5f, 0x6d, 0x5f, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x11, 0x68, 0x74, 0x6c, 0x63, 0x4d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x4d,
	0x41, 0x74, 0x6f, 0x6d, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x66, 0x65,
	...
	0x28, 0x0d, 0x52, 0x07, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x12, 0x2f, 0x0a, 0x14, 0x68,
	0x74, 0x6c, 0x63, 0x5f, 0x6d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d, 0x5f, 0x6d, 0x5f, 0x61, 0x74,
	0x6f, 0x6d, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x68, 0x74, 0x6c, 0x63, 0x4d,
	0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d, 0x4d, 0x41, 0x74, 0x6f, 0x6d, 0x73, 0x12, 0x2a, 0x0a, 0x11,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x22, 0xb8,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x10, 0x0a, 0x0e, 0x69, 0x6e, 0x74, 0x65, 0x72,
	...
	0x90, 0x01, 0x0a, 0x0a, 0x52, 0x50, 0x43, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x26,
	...
	0x65, 0x64, 0x22, 0xc1, 0x01, 0x0a, 0x15, 0x52, 0x50, 0x43, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65,
	0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x3b, 0x0a, 0x08, 0x72,
	...
	0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x2a, 0x78, 0x0a,
	...
	0x50, 0x55, 0x42, 0x4b, 0x45, 0x59, 0x5f, 0x48, 0x41, 0x53, 0x48, 0x10, 0x01, 0x12, 0x0f, 0x0a,
	0x0b, 0x50, 0x55, 0x42, 0x4b, 0x45, 0x59, 0x5f, 0x48, 0x41, 0x53, 0x48, 0x10, 0x02, 0x12, 0x0f,
	0x0a, 0x0b, 0x53, 0x43, 0x52, 0x49, 0x50, 0x54, 0x5f, 0x48, 0x41, 0x53, 0x48, 0x10, 0x03, 0x12,
	0x16, 0x0a, 0x12, 0x55, 0x4e, 0x55, 0x53, 0x45, 0x44, 0x5f, 0x50, 0x55, 0x42, 0x4b, 0x45, 0x59,
	0x5f, 0x48, 0x41, 0x53, 0x48, 0x10, 0x04, 0x2a, 0x5d, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x69,
	...
	0x48, 0x4f, 0x52, 0x53, 0x10, 0x03, 0x2a, 0x61, 0x0a, 0x09, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
	...
	0x52, 0x10, 0x04, 0x32, 0x96, 0x26, 0x0a, 0x09, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x69, 0x6e,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x50, 0x0a, 0x0f, 0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4e,
	0x6f, 0x64, 0x65, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e,
	0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x69, 0x6e, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x45,
	0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52,
	...
	0x12, 0x53, 0x0a, 0x10, 0x43, 0x61, 0x6c, 0x63, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x12, 0x1e, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x61, 0x6c,
	0x63, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x61, 0x6c,
	0x63, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x73,
	...
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x20, 0x5a, 0x1e,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x65, 0x63, 0x72, 0x65,
	0x64, 0x2f, 0x64, 0x63, 0x72, 0x6c, 0x6e, 0x64, 0x2f, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x62, 0x06,
...
var file_lightning_proto_msgTypes = make([]protoimpl.MessageInfo, 206)
var file_lightning_proto_goTypes = []interface{}{
	...
	(*SendCustomMessageRequest)(nil),                            // 19: lnrpc.SendCustomMessageRequest
	(*SendCustomMessageResponse)(nil),                           // 20: lnrpc.SendCustomMessageResponse
	(*Utxo)(nil),                                                // 21: lnrpc.Utxo
	(*Transaction)(nil),                                         // 22: lnrpc.Transaction
	(*GetTransactionsRequest)(nil),                              // 23: lnrpc.GetTransactionsRequest
	(*TransactionDetails)(nil),                                  // 24: lnrpc.TransactionDetails
	(*FeeLimit)(nil),                                            // 25: lnrpc.FeeLimit
	(*SendRequest)(nil),                                         // 26: lnrpc.SendRequest
	(*SendResponse)(nil),                                        // 27: lnrpc.SendResponse
	(*SendToRouteRequest)(nil),                                  // 28: lnrpc.SendToRouteRequest
	(*ChannelAcceptRequest)(nil),                                // 29: lnrpc.ChannelAcceptRequest
	(*ChannelAcceptResponse)(nil),                               // 30: lnrpc.ChannelAcceptResponse
	(*ChannelPoint)(nil),                                        // 31: lnrpc.ChannelPoint
	(*OutPoint)(nil),                                            // 32: lnrpc.OutPoint
	(*LightningAddress)(nil),                                    // 33: lnrpc.LightningAddress
	(*EstimateFeeRequest)(nil),                                  // 34: lnrpc.EstimateFeeRequest
	(*EstimateFeeResponse)(nil),                                 // 35: lnrpc.EstimateFeeResponse
	(*SendManyRequest)(nil),                                     // 36: lnrpc.SendManyRequest
	(*SendManyResponse)(nil),                                    // 37: lnrpc.SendManyResponse
	(*SendCoinsRequest)(nil),                                    // 38: lnrpc.SendCoinsRequest
	(*SendCoinsResponse)(nil),                                   // 39: lnrpc.SendCoinsResponse
	(*ListUnspentRequest)(nil),                                  // 40: lnrpc.ListUnspentRequest
	(*ListUnspentResponse)(nil),                                 // 41: lnrpc.ListUnspentResponse
	(*NewAddressRequest)(nil),                                   // 42: lnrpc.NewAddressRequest
	(*NewAddressResponse)(nil),                                  // 43: lnrpc.NewAddressResponse
	(*SignMessageRequest)(nil),                                  // 44: lnrpc.SignMessageRequest
	(*SignMessageResponse)(nil),                                 // 45: lnrpc.SignMessageResponse
	(*VerifyMessageRequest)(nil),                                // 46: lnrpc.VerifyMessageRequest
	(*VerifyMessageResponse)(nil),                               // 47: lnrpc.VerifyMessageResponse
	(*ConnectPeerRequest)(nil),                                  // 48: lnrpc.ConnectPeerRequest
	(*ConnectPeerResponse)(nil),                                 // 49: lnrpc.ConnectPeerResponse
	(*DisconnectPeerRequest)(nil),                               // 50: lnrpc.DisconnectPeerRequest
	(*DisconnectPeerResponse)(nil),                              // 51: lnrpc.DisconnectPeerResponse
	(*HTLC)(nil),                                                // 52: lnrpc.HTLC
	(*ChannelConstraints)(nil),                                  // 53: lnrpc.ChannelConstraints
	(*Channel)(nil),                                             // 54: lnrpc.Channel
	(*ListChannelsRequest)(nil),                                 // 55: lnrpc.ListChannelsRequest
	(*ListChannelsResponse)(nil),                                // 56: lnrpc.ListChannelsResponse
	(*ChannelCloseSummary)(nil),                                 // 57: lnrpc.ChannelCloseSummary
	(*Resolution)(nil),                                          // 58: lnrpc.Resolution
	(*ClosedChannelsRequest)(nil),                               // 59: lnrpc.ClosedChannelsRequest
	(*ClosedChannelsResponse)(nil),                              // 60: lnrpc.ClosedChannelsResponse
	(*Peer)(nil),                                                // 61: lnrpc.Peer
	(*TimestampedError)(nil),                                    // 62: lnrpc.TimestampedError
	(*ListPeersRequest)(nil),                                    // 63: lnrpc.ListPeersRequest
	(*ListPeersResponse)(nil),                                   // 64: lnrpc.ListPeersResponse
	(*PeerEventSubscription)(nil),                               // 65: lnrpc.PeerEventSubscription
	(*PeerEvent)(nil),                                           // 66: lnrpc.PeerEvent
	(*GetInfoRequest)(nil),                                      // 67: lnrpc.GetInfoRequest
	(*GetInfoResponse)(nil),                                     // 68: lnrpc.GetInfoResponse
	(*GetRecoveryInfoRequest)(nil),                              // 69: lnrpc.GetRecoveryInfoRequest
	(*GetRecoveryInfoResponse)(nil),                             // 70: lnrpc.GetRecoveryInfoResponse
	(*Chain)(nil),                                               // 71: lnrpc.Chain
	(*ConfirmationUpdate)(nil),                                  // 72: lnrpc.ConfirmationUpdate
	(*ChannelOpenUpdate)(nil),                                   // 73: lnrpc.ChannelOpenUpdate
	(*ChannelCloseUpdate)(nil),                                  // 74: lnrpc.ChannelCloseUpdate
	(*CloseChannelRequest)(nil),                                 // 75: lnrpc.CloseChannelRequest
	(*CloseStatusUpdate)(nil),                                   // 76: lnrpc.CloseStatusUpdate
	(*PendingUpdate)(nil),                                       // 77: lnrpc.PendingUpdate
	(*ReadyForPsbtFunding)(nil),                                 // 78: lnrpc.ReadyForPsbtFunding
	(*BatchOpenChannelRequest)(nil),                             // 79: lnrpc.BatchOpenChannelRequest
	(*BatchOpenChannel)(nil),                                    // 80: lnrpc.BatchOpenChannel
	(*BatchOpenChannelResponse)(nil),                            // 81: lnrpc.BatchOpenChannelResponse
	(*OpenChannelRequest)(nil),                                  // 82: lnrpc.OpenChannelRequest
	(*OpenStatusUpdate)(nil),                                    // 83: lnrpc.OpenStatusUpdate
	(*KeyLocator)(nil),                                          // 84: lnrpc.KeyLocator
	(*KeyDescriptor)(nil),                                       // 85: lnrpc.KeyDescriptor
	(*ChanPointShim)(nil),                                       // 86: lnrpc.ChanPointShim
	(*PsbtShim)(nil),                                            // 87: lnrpc.PsbtShim
	(*FundingShim)(nil),                                         // 88: lnrpc.FundingShim
	(*FundingShimCancel)(nil),                                   // 89: lnrpc.FundingShimCancel
	(*FundingPsbtVerify)(nil),                                   // 90: lnrpc.FundingPsbtVerify
	(*FundingPsbtFinalize)(nil),                                 // 91: lnrpc.FundingPsbtFinalize
	(*FundingTransitionMsg)(nil),                                // 92: lnrpc.FundingTransitionMsg
	(*FundingStateStepResp)(nil),                                // 93: lnrpc.FundingStateStepResp
	(*PendingHTLC)(nil),                                         // 94: lnrpc.PendingHTLC
	(*PendingChannelsRequest)(nil),                              // 95: lnrpc.PendingChannelsRequest
	(*PendingChannelsResponse)(nil),                             // 96: lnrpc.PendingChannelsResponse
	(*ChannelEventSubscription)(nil),                            // 97: lnrpc.ChannelEventSubscription
	(*ChannelEventUpdate)(nil),                                  // 98: lnrpc.ChannelEventUpdate
	(*WalletAccountBalance)(nil),                                // 99: lnrpc.WalletAccountBalance
	(*WalletBalanceRequest)(nil),                                // 100: lnrpc.WalletBalanceRequest
	(*WalletBalanceResponse)(nil),                               // 101: lnrpc.WalletBalanceResponse
	(*Amount)(nil),                                              // 102: lnrpc.Amount
	(*ChannelBalanceRequest)(nil),                               // 103: lnrpc.ChannelBalanceRequest
	(*ChannelBalanceResponse)(nil),                              // 104: lnrpc.ChannelBalanceResponse
	(*QueryRoutesRequest)(nil),                                  // 105: lnrpc.QueryRoutesRequest
	(*NodePair)(nil),                                            // 106: lnrpc.NodePair
	(*EdgeLocator)(nil),                                         // 107: lnrpc.EdgeLocator
	(*QueryRoutesResponse)(nil),                                 // 108: lnrpc.QueryRoutesResponse
	(*Hop)(nil),                                                 // 109: lnrpc.Hop
	(*MPPRecord)(nil),                                           // 110: lnrpc.MPPRecord
	(*AMPRecord)(nil),                                           // 111: lnrpc.AMPRecord
	(*Route)(nil),                                               // 112: lnrpc.Route
	(*NodeInfoRequest)(nil),                                     // 113: lnrpc.NodeInfoRequest
	(*NodeInfo)(nil),                                            // 114: lnrpc.NodeInfo
	(*LightningNode)(nil),                                       // 115: lnrpc.LightningNode
	(*NodeAddress)(nil),                                         // 116: lnrpc.NodeAddress
	(*RoutingPolicy)(nil),                                       // 117: lnrpc.RoutingPolicy
	(*EnforceNodePingRequest)(nil),                              // 118: lnrpc.EnforceNodePingRequest
	(*EnforceNodePingResponse)(nil),                             // 119: lnrpc.EnforceNodePingResponse
	...
	(*RouteHint)(nil),                                           // 137: lnrpc.RouteHint
	(*Invoice)(nil),                                             // 138: lnrpc.Invoice
	(*InvoiceHTLC)(nil),                                         // 139: lnrpc.InvoiceHTLC
	(*AMP)(nil),                                                 // 140: lnrpc.AMP
	(*AddInvoiceResponse)(nil),                                  // 141: lnrpc.AddInvoiceResponse
	(*PaymentHash)(nil),                                         // 142: lnrpc.PaymentHash
	(*ListInvoiceRequest)(nil),                                  // 143: lnrpc.ListInvoiceRequest
	(*ListInvoiceResponse)(nil),                                 // 144: lnrpc.ListInvoiceResponse
	(*InvoiceSubscription)(nil),                                 // 145: lnrpc.InvoiceSubscription
	(*Payment)(nil),                                             // 146: lnrpc.Payment
	(*HTLCAttempt)(nil),                                         // 147: lnrpc.HTLCAttempt
	(*ListPaymentsRequest)(nil),                                 // 148: lnrpc.ListPaymentsRequest
	(*ListPaymentsResponse)(nil),                                // 149: lnrpc.ListPaymentsResponse
	(*DeletePaymentRequest)(nil),                                // 150: lnrpc.DeletePaymentRequest
	(*DeleteAllPaymentsRequest)(nil),                            // 151: lnrpc.DeleteAllPaymentsRequest
	(*DeletePaymentResponse)(nil),                               // 152: lnrpc.DeletePaymentResponse
	(*DeleteAllPaymentsResponse)(nil),                           // 153: lnrpc.DeleteAllPaymentsResponse
	(*AbandonChannelRequest)(nil),                               // 154: lnrpc.AbandonChannelRequest
	(*AbandonChannelResponse)(nil),                              // 155: lnrpc.AbandonChannelResponse
	(*DebugLevelRequest)(nil),                                   // 156: lnrpc.DebugLevelRequest
	(*DebugLevelResponse)(nil),                                  // 157: lnrpc.DebugLevelResponse
	(*CalcPaymentStatsRequest)(nil),                             // 158: lnrpc.CalcPaymentStatsRequest
	(*CalcPaymentStatsResponse)(nil),                            // 159: lnrpc.CalcPaymentStatsResponse
	...
	nil, // 222: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 223: lnrpc.PayReq.FeaturesEntry
	nil, // 224: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
}
var file_lightning_proto_depIdxs = []int32{
	0,   // 0: lnrpc.Utxo.address_type:type_name -> lnrpc.AddressType
	32,  // 1: lnrpc.Utxo.outpoint:type_name -> lnrpc.OutPoint
	22,  // 2: lnrpc.TransactionDetails.transactions:type_name -> lnrpc.Transaction
	25,  // 3: lnrpc.SendRequest.fee_limit:type_name -> lnrpc.FeeLimit
	...
	112, // 6: lnrpc.SendResponse.payment_route:type_name -> lnrpc.Route
	112, // 7: lnrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	...
	21,  // 10: lnrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	0,   // 11: lnrpc.NewAddressRequest.type:type_name -> lnrpc.AddressType
	33,  // 12: lnrpc.ConnectPeerRequest.addr:type_name -> lnrpc.LightningAddress
	52,  // 13: lnrpc.Channel.pending_htlcs:type_name -> lnrpc.HTLC
	1,   // 14: lnrpc.Channel.commitment_type:type_name -> lnrpc.CommitmentType
	53,  // 15: lnrpc.Channel.local_constraints:type_name -> lnrpc.ChannelConstraints
	53,  // 16: lnrpc.Channel.remote_constraints:type_name -> lnrpc.ChannelConstraints
	54,  // 17: lnrpc.ListChannelsResponse.channels:type_name -> lnrpc.Channel
	...
	58,  // 21: lnrpc.ChannelCloseSummary.resolutions:type_name -> lnrpc.Resolution
	...
	32,  // 24: lnrpc.Resolution.outpoint:type_name -> lnrpc.OutPoint
	57,  // 25: lnrpc.ClosedChannelsResponse.channels:type_name -> lnrpc.ChannelCloseSummary
	11,  // 26: lnrpc.Peer.sync_type:type_name -> lnrpc.Peer.SyncType
	207, // 27: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	62,  // 28: lnrpc.Peer.errors:type_name -> lnrpc.TimestampedError
	61,  // 29: lnrpc.ListPeersResponse.peers:type_name -> lnrpc.Peer
	12,  // 30: lnrpc.PeerEvent.type:type_name -> lnrpc.PeerEvent.EventType
	71,  // 31: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	208, // 32: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	31,  // 33: lnrpc.ChannelOpenUpdate.channel_point:type_name -> lnrpc.ChannelPoint
	31,  // 34: lnrpc.CloseChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	77,  // 35: lnrpc.CloseStatusUpdate.close_pending:type_name -> lnrpc.PendingUpdate
	74,  // 36: lnrpc.CloseStatusUpdate.chan_close:type_name -> lnrpc.ChannelCloseUpdate
	80,  // 37: lnrpc.BatchOpenChannelRequest.channels:type_name -> lnrpc.BatchOpenChannel
	1,   // 38: lnrpc.BatchOpenChannel.commitment_type:type_name -> lnrpc.CommitmentType
	77,  // 39: lnrpc.BatchOpenChannelResponse.pending_channels:type_name -> lnrpc.PendingUpdate
	88,  // 40: lnrpc.OpenChannelRequest.funding_shim:type_name -> lnrpc.FundingShim
	1,   // 41: lnrpc.OpenChannelRequest.commitment_type:type_name -> lnrpc.CommitmentType
	77,  // 42: lnrpc.OpenStatusUpdate.chan_pending:type_name -> lnrpc.PendingUpdate
	73,  // 43: lnrpc.OpenStatusUpdate.chan_open:type_name -> lnrpc.ChannelOpenUpdate
	78,  // 44: lnrpc.OpenStatusUpdate.psbt_fund:type_name -> lnrpc.ReadyForPsbtFunding
	84,  // 45: lnrpc.KeyDescriptor.key_loc:type_name -> lnrpc.KeyLocator
	31,  // 46: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	85,  // 47: lnrpc.ChanPointShim.local_key:type_name -> lnrpc.KeyDescriptor
	86,  // 48: lnrpc.FundingShim.chan_point_shim:type_name -> lnrpc.ChanPointShim
	87,  // 49: lnrpc.FundingShim.psbt_shim:type_name -> lnrpc.PsbtShim
	88,  // 50: lnrpc.FundingTransitionMsg.shim_register:type_name -> lnrpc.FundingShim
	89,  // 51: lnrpc.FundingTransitionMsg.shim_cancel:type_name -> lnrpc.FundingShimCancel
	90,  // 52: lnrpc.FundingTransitionMsg.psbt_verify:type_name -> lnrpc.FundingPsbtVerify
	91,  // 53: lnrpc.FundingTransitionMsg.psbt_finalize:type_name -> lnrpc.FundingPsbtFinalize
	210, // 54: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	213, // 55: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	214, // 56: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	211, // 57: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	54,  // 58: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	57,  // 59: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	31,  // 60: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	31,  // 61: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	77,  // 62: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	31,  // 63: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	14,  // 64: lnrpc.ChannelEventUpdate.type:type_name -> lnrpc.ChannelEventUpdate.UpdateType
	215, // 65: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	102, // 66: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	102, // 67: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	102, // 68: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	102, // 69: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	102, // 70: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	102, // 71: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	25,  // 72: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	107, // 73: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	106, // 74: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	216, // 75: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	112, // 78: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	110, // 79: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	111, // 80: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	217, // 81: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	109, // 82: lnrpc.Route.hops:type_name -> lnrpc.Hop
	115, // 83: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	120, // 84: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	116, // 85: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	218, // 86: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	117, // 87: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	117, // 88: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	115, // 89: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	...
	219, // 92: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	116, // 96: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	220, // 97: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	31,  // 98: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	117, // 99: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	31,  // 100: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	...
	221, // 105: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	6,   // 106: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	222, // 107: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	112, // 114: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	192, // 115: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	146, // 116: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	31,  // 117: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	137, // 118: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	223, // 119: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	164, // 120: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	31,  // 121: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	32,  // 122: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	9,   // 123: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	167, // 124: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	170, // 125: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	31,  // 126: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	31,  // 127: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	31,  // 128: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	177, // 129: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	174, // 130: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	173, // 131: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	177, // 132: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	182, // 133: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	182, // 134: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	224, // 135: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	18,  // 136: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	193, // 137: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	195, // 138: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	182, // 139: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	199, // 140: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	200, // 141: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	200, // 142: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	202, // 143: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	203, // 144: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	162, // 145: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	162, // 146: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	209, // 149: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	209, // 150: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	212, // 151: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	209, // 152: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	209, // 153: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	94,  // 154: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	99,  // 156: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	162, // 157: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	125, // 158: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	162, // 159: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	162, // 160: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	162, // 161: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	189, // 162: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	100, // 163: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	103, // 164: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	23,  // 165: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	34,  // 166: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	38,  // 167: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	40,  // 168: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	23,  // 169: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	36,  // 170: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	42,  // 171: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	44,  // 172: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	46,  // 173: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	48,  // 174: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	50,  // 175: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	63,  // 176: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	65,  // 177: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	67,  // 178: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	69,  // 179: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	95,  // 180: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	55,  // 181: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	97,  // 182: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	59,  // 183: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	82,  // 184: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	82,  // 185: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	79,  // 186: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	92,  // 187: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	30,  // 188: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	75,  // 189: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	154, // 190: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	26,  // 191: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	26,  // 192: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	28,  // 193: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	28,  // 194: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	...
	160, // 199: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	...
	113, // 206: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	118, // 207: lnrpc.Lightning.EnforceNodePing:input_type -> lnrpc.EnforceNodePingRequest
	105, // 208: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	...
	158, // 213: lnrpc.Lightning.CalcPaymentStats:input_type -> lnrpc.CalcPaymentStatsRequest
	163, // 214: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	166, // 215: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	169, // 216: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	172, // 217: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	175, // 218: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	176, // 219: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	178, // 220: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	180, // 221: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	183, // 222: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	185, // 223: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	187, // 224: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	190, // 225: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	196, // 226: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	201, // 227: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	19,  // 228: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	101, // 229: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	104, // 230: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	24,  // 231: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	35,  // 232: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	39,  // 233: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	41,  // 234: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	22,  // 235: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	37,  // 236: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	43,  // 237: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	45,  // 238: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	47,  // 239: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	49,  // 240: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	51,  // 241: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	64,  // 242: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	66,  // 243: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	68,  // 244: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	70,  // 245: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	96,  // 246: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	56,  // 247: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	98,  // 248: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	60,  // 249: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	31,  // 250: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	83,  // 251: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	81,  // 252: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	93,  // 253: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	29,  // 254: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	76,  // 255: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	155, // 256: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	27,  // 257: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	27,  // 258: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	27,  // 259: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	27,  // 260: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	...
	161, // 265: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	...
	114, // 272: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	119, // 273: lnrpc.Lightning.EnforceNodePing:output_type -> lnrpc.EnforceNodePingResponse
	108, // 274: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	128, // 275: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	130, // 276: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	132, // 277: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	157, // 278: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	159, // 279: lnrpc.Lightning.CalcPaymentStats:output_type -> lnrpc.CalcPaymentStatsResponse
	165, // 280: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	168, // 281: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	171, // 282: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	173, // 283: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	176, // 284: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	181, // 285: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	179, // 286: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	176, // 287: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	184, // 288: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	186, // 289: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	188, // 290: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	191, // 291: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	197, // 292: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	198, // 293: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	20,  // 294: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	229, // [229:295] is the sub-list for method output_type
	163, // [163:229] is the sub-list for method input_type
...
func file_lightning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lightning_proto_msgTypes[99].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnforceNodePingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lightning_proto_msgTypes[100].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnforceNodePingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lightning_proto_msgTypes[139].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalcPaymentStatsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lightning_proto_msgTypes[140].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalcPaymentStatsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_lightning_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*FeeLimit_Fixed)(nil),
		(*FeeLimit_FixedMAtoms)(nil),
		(*FeeLimit_Percent)(nil),
	}
	file_lightning_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*ChannelPoint_FundingTxidBytes)(nil),
		(*ChannelPoint_FundingTxidStr)(nil),
	}
	file_lightning_proto_msgTypes[57].OneofWrappers = []interface{}{
...
type LightningClient interface {
	...
	CalcPaymentStats(ctx context.Context, in *CalcPaymentStatsRequest, opts ...grpc.CallOption) (*CalcPaymentStatsResponse, error)
	// lncli: `feereport`
...
func (c *lightningClient) EnforceNodePing(ctx context.Context, in *EnforceNodePingRequest, opts ...grpc.CallOption) (*EnforceNodePingResponse, error) {
	out := new(EnforceNodePingResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/EnforceNodePing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) CalcPaymentStats(ctx context.Context, in *CalcPaymentStatsRequest, opts ...grpc.CallOption) (*CalcPaymentStatsResponse, error) {
	out := new(CalcPaymentStatsResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/CalcPaymentStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightningServer interface {
	...
	// CalcPaymentStats goes through the DB and generates a report on total
	// number of payments recorded.
	CalcPaymentStats(context.Context, *CalcPaymentStatsRequest) (*CalcPaymentStatsResponse, error)
	// lncli: `feereport`
	// FeeReport allows the caller to obtain a report detailing the current fee
	// schedule enforced by the node globally for each channel.
...
func (*UnimplementedLightningServer) EnforceNodePing(context.Context, *EnforceNodePingRequest) (*EnforceNodePingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnforceNodePing not implemented")
}
...
func (*UnimplementedLightningServer) CalcPaymentStats(context.Context, *CalcPaymentStatsRequest) (*CalcPaymentStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CalcPaymentStats not implemented")
}
...
func _Lightning_EnforceNodePing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnforceNodePingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).EnforceNodePing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/EnforceNodePing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).EnforceNodePing(ctx, req.(*EnforceNodePingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Lightning_CalcPaymentStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CalcPaymentStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).CalcPaymentStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/CalcPaymentStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).CalcPaymentStats(ctx, req.(*CalcPaymentStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnforceNodePing",
			Handler:    _Lightning_EnforceNodePing_Handler,
		},
		{
		...
		{
			MethodName: "CalcPaymentStats",
			Handler:    _Lightning_CalcPaymentStats_Handler,
		},
		{
