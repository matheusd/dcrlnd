...
var file_lightning_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0xda, 0x03,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x22, 0xfb, 0x02, 0x0a, 0x15, 0x43,
...
var file_lightning_proto_depIdxs = []int32{
	...
	207, // 8: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	208, // 9: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	209, // 27: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	210, // 32: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	...
	212, // 54: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	215, // 55: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	216, // 56: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	213, // 57: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	217, // 65: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	218, // 75: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	139, // 76: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	...
	219, // 81: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	111, // 82: lnrpc.Route.hops:type_name -> lnrpc.Hop
	117, // 83: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	122, // 84: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	118, // 85: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	220, // 86: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	...
	122, // 90: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	5,   // 91: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	221, // 92: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	135, // 93: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	136, // 94: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	137, // 95: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	118, // 96: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	222, // 97: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	138, // 101: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	139, // 102: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	15,  // 103: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	141, // 104: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	223, // 105: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	6,   // 106: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	224, // 107: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	142, // 108: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	140, // 109: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	16,  // 110: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	149, // 111: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	194, // 115: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	148, // 116: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	33,  // 117: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	139, // 118: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	225, // 119: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	166, // 120: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	...
	169, // 124: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	172, // 125: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	...
	179, // 129: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	176, // 130: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	175, // 131: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	179, // 132: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	184, // 133: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	184, // 134: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	226, // 135: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	18,  // 136: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	195, // 137: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	197, // 138: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	184, // 139: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	201, // 140: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	202, // 141: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	202, // 142: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	204, // 143: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	205, // 144: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	164, // 145: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	164, // 146: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	211, // 149: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	211, // 150: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	214, // 151: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	211, // 152: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	211, // 153: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	164, // 157: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	127, // 158: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	164, // 159: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	164, // 160: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	164, // 161: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	191, // 162: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	...
	156, // 190: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	140, // 195: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	145, // 196: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	144, // 197: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	147, // 198: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	162, // 199: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	150, // 200: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	152, // 201: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	153, // 202: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	123, // 203: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	125, // 204: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	128, // 205: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	115, // 206: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	120, // 207: lnrpc.Lightning.EnforceNodePing:input_type -> lnrpc.EnforceNodePingRequest
	107, // 208: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	129, // 209: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	131, // 210: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	133, // 211: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	158, // 212: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	160, // 213: lnrpc.Lightning.CalcPaymentStats:input_type -> lnrpc.CalcPaymentStatsRequest
	165, // 214: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	168, // 215: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	171, // 216: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	174, // 217: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	177, // 218: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	178, // 219: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	180, // 220: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	182, // 221: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	185, // 222: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	187, // 223: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	189, // 224: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	192, // 225: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	198, // 226: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	203, // 227: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	21,  // 228: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	19,  // 229: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	103, // 230: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	106, // 231: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	26,  // 232: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	37,  // 233: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	41,  // 234: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	43,  // 235: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	24,  // 236: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	39,  // 237: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	45,  // 238: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	47,  // 239: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	49,  // 240: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	51,  // 241: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	53,  // 242: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	66,  // 243: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	68,  // 244: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	70,  // 245: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	72,  // 246: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	98,  // 247: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	58,  // 248: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	100, // 249: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	62,  // 250: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	33,  // 251: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	85,  // 252: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	83,  // 253: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	95,  // 254: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	31,  // 255: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	78,  // 256: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	157, // 257: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	29,  // 258: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	29,  // 259: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	29,  // 260: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	29,  // 261: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	143, // 262: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	146, // 263: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	140, // 264: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	140, // 265: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	163, // 266: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	151, // 267: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	154, // 268: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	155, // 269: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	124, // 270: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	126, // 271: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	122, // 272: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	116, // 273: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	121, // 274: lnrpc.Lightning.EnforceNodePing:output_type -> lnrpc.EnforceNodePingResponse
	110, // 275: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	130, // 276: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	132, // 277: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	134, // 278: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	159, // 279: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	161, // 280: lnrpc.Lightning.CalcPaymentStats:output_type -> lnrpc.CalcPaymentStatsResponse
	167, // 281: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	170, // 282: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	173, // 283: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	175, // 284: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	178, // 285: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	183, // 286: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	181, // 287: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	178, // 288: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	186, // 289: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	188, // 290: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	190, // 291: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	193, // 292: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	199, // 293: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	200, // 294: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	230, // [230:297] is the sub-list for method output_type
	163, // [163:230] is the sub-list for method input_type
