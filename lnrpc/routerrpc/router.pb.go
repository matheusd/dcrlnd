...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x68, 0x74, 0x6c, 0x63, 0x73, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x2a, 0x81,
	...
	0x45, 0x10, 0x06, 0x32, 0xdc, 0x07, 0x0a, 0x06, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x12, 0x40,
...
var file_routerrpc_router_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_routerrpc_router_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_routerrpc_router_proto_goTypes = []interface{}{
	...
	(HtlcEvent_EventType)(0),            // 2: routerrpc.HtlcEvent.EventType
	(*SendPaymentRequest)(nil),          // 3: routerrpc.SendPaymentRequest
	(*TrackPaymentRequest)(nil),         // 4: routerrpc.TrackPaymentRequest
	(*RouteFeeRequest)(nil),             // 5: routerrpc.RouteFeeRequest
	(*RouteFeeResponse)(nil),            // 6: routerrpc.RouteFeeResponse
	(*SendToRouteRequest)(nil),          // 7: routerrpc.SendToRouteRequest
	(*SendToRouteResponse)(nil),         // 8: routerrpc.SendToRouteResponse
	(*ResetMissionControlRequest)(nil),  // 9: routerrpc.ResetMissionControlRequest
	(*ResetMissionControlResponse)(nil), // 10: routerrpc.ResetMissionControlResponse
	(*QueryMissionControlRequest)(nil),  // 11: routerrpc.QueryMissionControlRequest
	(*QueryMissionControlResponse)(nil), // 12: routerrpc.QueryMissionControlResponse
	(*PairHistory)(nil),                 // 13: routerrpc.PairHistory
	(*PairData)(nil),                    // 14: routerrpc.PairData
	(*QueryProbabilityRequest)(nil),     // 15: routerrpc.QueryProbabilityRequest
	(*QueryProbabilityResponse)(nil),    // 16: routerrpc.QueryProbabilityResponse
	(*BuildRouteRequest)(nil),           // 17: routerrpc.BuildRouteRequest
	(*BuildRouteResponse)(nil),          // 18: routerrpc.BuildRouteResponse
	(*SubscribeHtlcEventsRequest)(nil),  // 19: routerrpc.SubscribeHtlcEventsRequest
	(*HtlcEvent)(nil),                   // 20: routerrpc.HtlcEvent
	(*HtlcInfo)(nil),                    // 21: routerrpc.HtlcInfo
	(*ForwardEvent)(nil),                // 22: routerrpc.ForwardEvent
	(*ForwardFailEvent)(nil),            // 23: routerrpc.ForwardFailEvent
	(*SettleEvent)(nil),                 // 24: routerrpc.SettleEvent
	(*LinkFailEvent)(nil),               // 25: routerrpc.LinkFailEvent
	(*PaymentStatus)(nil),               // 26: routerrpc.PaymentStatus
	nil,                                 // 27: routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	(*lnrpc.RouteHint)(nil),             // 28: lnrpc.RouteHint
	(lnrpc.FeatureBit)(0),               // 29: lnrpc.FeatureBit
	(*lnrpc.Route)(nil),                 // 30: lnrpc.Route
	(*lnrpc.Failure)(nil),               // 31: lnrpc.Failure
	(lnrpc.Failure_FailureCode)(0),      // 32: lnrpc.Failure.FailureCode
	(*lnrpc.HTLCAttempt)(nil),           // 33: lnrpc.HTLCAttempt
	(*lnrpc.Payment)(nil),               // 34: lnrpc.Payment
}
var file_routerrpc_router_proto_depIdxs = []int32{
	28, // 0: routerrpc.SendPaymentRequest.route_hints:type_name -> lnrpc.RouteHint
	27, // 1: routerrpc.SendPaymentRequest.dest_custom_records:type_name -> routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	29, // 2: routerrpc.SendPaymentRequest.dest_features:type_name -> lnrpc.FeatureBit
	30, // 3: routerrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	31, // 4: routerrpc.SendToRouteResponse.failure:type_name -> lnrpc.Failure
	13, // 5: routerrpc.QueryMissionControlResponse.pairs:type_name -> routerrpc.PairHistory
	14, // 6: routerrpc.PairHistory.history:type_name -> routerrpc.PairData
	14, // 7: routerrpc.QueryProbabilityResponse.history:type_name -> routerrpc.PairData
	30, // 8: routerrpc.BuildRouteResponse.route:type_name -> lnrpc.Route
	2,  // 9: routerrpc.HtlcEvent.event_type:type_name -> routerrpc.HtlcEvent.EventType
	22, // 10: routerrpc.HtlcEvent.forward_event:type_name -> routerrpc.ForwardEvent
	23, // 11: routerrpc.HtlcEvent.forward_fail_event:type_name -> routerrpc.ForwardFailEvent
	24, // 12: routerrpc.HtlcEvent.settle_event:type_name -> routerrpc.SettleEvent
	25, // 13: routerrpc.HtlcEvent.link_fail_event:type_name -> routerrpc.LinkFailEvent
	21, // 14: routerrpc.ForwardEvent.info:type_name -> routerrpc.HtlcInfo
	21, // 15: routerrpc.LinkFailEvent.info:type_name -> routerrpc.HtlcInfo
	32, // 16: routerrpc.LinkFailEvent.wire_failure:type_name -> lnrpc.Failure.FailureCode
	...
	33, // 19: routerrpc.PaymentStatus.htlcs:type_name -> lnrpc.HTLCAttempt
	3,  // 20: routerrpc.Router.SendPaymentV2:input_type -> routerrpc.SendPaymentRequest
	4,  // 21: routerrpc.Router.TrackPaymentV2:input_type -> routerrpc.TrackPaymentRequest
	5,  // 22: routerrpc.Router.EstimateRouteFee:input_type -> routerrpc.RouteFeeRequest
	7,  // 23: routerrpc.Router.SendToRoute:input_type -> routerrpc.SendToRouteRequest
	7,  // 24: routerrpc.Router.SendToRouteV2:input_type -> routerrpc.SendToRouteRequest
	9,  // 25: routerrpc.Router.ResetMissionControl:input_type -> routerrpc.ResetMissionControlRequest
	11, // 26: routerrpc.Router.QueryMissionControl:input_type -> routerrpc.QueryMissionControlRequest
	15, // 27: routerrpc.Router.QueryProbability:input_type -> routerrpc.QueryProbabilityRequest
	17, // 28: routerrpc.Router.BuildRoute:input_type -> routerrpc.BuildRouteRequest
	19, // 29: routerrpc.Router.SubscribeHtlcEvents:input_type -> routerrpc.SubscribeHtlcEventsRequest
	3,  // 30: routerrpc.Router.SendPayment:input_type -> routerrpc.SendPaymentRequest
	4,  // 31: routerrpc.Router.TrackPayment:input_type -> routerrpc.TrackPaymentRequest
	34, // 32: routerrpc.Router.SendPaymentV2:output_type -> lnrpc.Payment
	34, // 33: routerrpc.Router.TrackPaymentV2:output_type -> lnrpc.Payment
	6,  // 34: routerrpc.Router.EstimateRouteFee:output_type -> routerrpc.RouteFeeResponse
	8,  // 35: routerrpc.Router.SendToRoute:output_type -> routerrpc.SendToRouteResponse
	33, // 36: routerrpc.Router.SendToRouteV2:output_type -> lnrpc.HTLCAttempt
	10, // 37: routerrpc.Router.ResetMissionControl:output_type -> routerrpc.ResetMissionControlResponse
	12, // 38: routerrpc.Router.QueryMissionControl:output_type -> routerrpc.QueryMissionControlResponse
	16, // 39: routerrpc.Router.QueryProbability:output_type -> routerrpc.QueryProbabilityResponse
	18, // 40: routerrpc.Router.BuildRoute:output_type -> routerrpc.BuildRouteResponse
	20, // 41: routerrpc.Router.SubscribeHtlcEvents:output_type -> routerrpc.HtlcEvent
	26, // 42: routerrpc.Router.SendPayment:output_type -> routerrpc.PaymentStatus
	26, // 43: routerrpc.Router.TrackPayment:output_type -> routerrpc.PaymentStatus
