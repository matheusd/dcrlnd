...
func TestSelectHopHints(t *testing.T) {
	var (
		...
		privateChannel1Hint = zpay32.HopHint{
			...
			FeeBaseMAtoms: uint32(privateChan1Policy.FeeBaseMAtoms),
		...
		privateChannel2Hint = zpay32.HopHint{
			...
			FeeBaseMAtoms: uint32(privateChan2Policy.FeeBaseMAtoms),
			FeeProportionalMillionths: uint32(
		...
		privateChannel3Hint = zpay32.HopHint{
			...
			FeeBaseMAtoms: uint32(privateChan3Policy.FeeBaseMAtoms),
			FeeProportionalMillionths: uint32(
