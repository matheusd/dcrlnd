...
var file_rpc_proto_rawDesc = []byte{
	...
	0x9a, 0x08, 0x0a, 0x07, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x2e, 0x0a, 0x04, 0x63,
	...
	0xd4, 0x05, 0x0a, 0x0b, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12,
	...
	0x72, 0x61, 0x4f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x44, 0x61, 0x74, 0x61, 0x2a, 0x78, 0x0a, 0x0b,
	...
	0x48, 0x41, 0x53, 0x48, 0x10, 0x04, 0x2a, 0x5e, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x4c, 0x45, 0x47, 0x41,
	0x43, 0x59, 0x10, 0x00, 0x12, 0x15, 0x0a, 0x11, 0x53, 0x54, 0x41, 0x54, 0x49, 0x43, 0x5f, 0x52,
	0x45, 0x4d, 0x4f, 0x54, 0x45, 0x5f, 0x4b, 0x45, 0x59, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x41,
	0x4e, 0x43, 0x48, 0x4f, 0x52, 0x53, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x17, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x5f, 0x43, 0x4f, 0x4d, 0x4d, 0x49, 0x54, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x54,
	0x59, 0x50, 0x45, 0x10, 0xe7, 0x07, 0x2a, 0x61, 0x0a, 0x09, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
	...
	0x10, 0x05, 0x2a, 0xa5, 0x03, 0x0a, 0x0a, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x69,
	...
	0x07, 0x4d, 0x50, 0x50, 0x5f, 0x4f, 0x50, 0x54, 0x10, 0x11, 0x32, 0xc9, 0x21, 0x0a, 0x09, 0x4c,
...
var file_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 178)
var file_rpc_proto_goTypes = []interface{}{
	...
	nil,                                                         // 177: lnrpc.SendRequest.DestCustomRecordsEntry
	nil,                                                         // 178: lnrpc.EstimateFeeRequest.AddrToAmountEntry
	nil,                                                         // 179: lnrpc.SendManyRequest.AddrToAmountEntry
	nil,                                                         // 180: lnrpc.Peer.FeaturesEntry
	nil,                                                         // 181: lnrpc.GetInfoResponse.FeaturesEntry
	(*PendingChannelsResponse_PendingChannel)(nil),              // 182: lnrpc.PendingChannelsResponse.PendingChannel
	(*PendingChannelsResponse_PendingOpenChannel)(nil),          // 183: lnrpc.PendingChannelsResponse.PendingOpenChannel
	(*PendingChannelsResponse_WaitingCloseChannel)(nil),         // 184: lnrpc.PendingChannelsResponse.WaitingCloseChannel
	(*PendingChannelsResponse_Commitments)(nil),                 // 185: lnrpc.PendingChannelsResponse.Commitments
	(*PendingChannelsResponse_ClosedChannel)(nil),               // 186: lnrpc.PendingChannelsResponse.ClosedChannel
	(*PendingChannelsResponse_ForceClosedChannel)(nil),          // 187: lnrpc.PendingChannelsResponse.ForceClosedChannel
	nil, // 188: lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	nil, // 189: lnrpc.Hop.CustomRecordsEntry
	nil, // 190: lnrpc.LightningNode.FeaturesEntry
	nil, // 191: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	nil, // 192: lnrpc.Invoice.FeaturesEntry
	nil, // 193: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 194: lnrpc.PayReq.FeaturesEntry
	nil, // 195: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
}
var file_rpc_proto_depIdxs = []int32{
	...
	177, // 4: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	178, // 8: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	179, // 9: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	180, // 27: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	181, // 32: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	...
	183, // 50: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	186, // 51: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	187, // 52: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	184, // 53: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	188, // 63: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	189, // 68: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	190, // 73: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	...
	191, // 79: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	192, // 90: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	6,   // 91: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	193, // 92: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	194, // 103: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	195, // 116: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	146, // 119: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	146, // 120: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	2,   // 121: lnrpc.PendingChannelsResponse.PendingChannel.initiator:type_name -> lnrpc.Initiator
	1,   // 122: lnrpc.PendingChannelsResponse.PendingChannel.commitment_type:type_name -> lnrpc.CommitmentType
	182, // 123: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	182, // 124: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	185, // 125: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	182, // 126: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	182, // 127: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	88,  // 128: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	12,  // 129: lnrpc.PendingChannelsResponse.ForceClosedChannel.anchor:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	146, // 130: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	114, // 131: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	146, // 132: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	146, // 133: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	172, // 134: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	93,  // 135: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	95,  // 136: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	20,  // 137: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	31,  // 138: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	35,  // 139: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	37,  // 140: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	20,  // 141: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	33,  // 142: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	39,  // 143: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	41,  // 144: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	43,  // 145: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	45,  // 146: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	47,  // 147: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	60,  // 148: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	62,  // 149: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	64,  // 150: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	66,  // 151: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	89,  // 152: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	52,  // 153: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	91,  // 154: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	56,  // 155: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	76,  // 156: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	76,  // 157: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	86,  // 158: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	27,  // 159: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	72,  // 160: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	140, // 161: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	23,  // 162: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	23,  // 163: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	25,  // 164: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	25,  // 165: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	127, // 166: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	131, // 167: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	130, // 168: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	133, // 169: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	144, // 170: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	136, // 171: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	138, // 172: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	110, // 173: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	112, // 174: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	115, // 175: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	104, // 176: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	97,  // 177: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	116, // 178: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	118, // 179: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	120, // 180: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	142, // 181: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	147, // 182: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	150, // 183: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	152, // 184: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	155, // 185: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	158, // 186: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	159, // 187: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	161, // 188: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	163, // 189: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	166, // 190: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	168, // 191: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	170, // 192: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	173, // 193: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	94,  // 194: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	96,  // 195: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	21,  // 196: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	32,  // 197: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	36,  // 198: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	38,  // 199: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	19,  // 200: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	34,  // 201: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	40,  // 202: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	42,  // 203: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	44,  // 204: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	46,  // 205: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	48,  // 206: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	61,  // 207: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	63,  // 208: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	65,  // 209: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	67,  // 210: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	90,  // 211: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	53,  // 212: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	92,  // 213: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	57,  // 214: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	28,  // 215: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	77,  // 216: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	87,  // 217: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	26,  // 218: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	73,  // 219: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	141, // 220: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	24,  // 221: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	24,  // 222: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	24,  // 223: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	24,  // 224: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	129, // 225: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	132, // 226: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	127, // 227: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	127, // 228: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	145, // 229: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	137, // 230: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	139, // 231: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	111, // 232: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	113, // 233: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	109, // 234: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	105, // 235: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	100, // 236: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	117, // 237: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	119, // 238: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	121, // 239: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	143, // 240: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	149, // 241: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	151, // 242: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	154, // 243: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	156, // 244: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	159, // 245: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	164, // 246: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	162, // 247: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	159, // 248: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	167, // 249: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	169, // 250: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	171, // 251: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	174, // 252: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	194, // [194:253] is the sub-list for method output_type
	135, // [135:194] is the sub-list for method input_type
