...
func getMaxOutgoingAmt(node route.Vertex, outgoingChan *uint64,
	g *graphParams, tx *bolt.Tx) (lnwire.MilliAtom, error) {

	var max lnwire.MilliAtom
	cb := func(_ *bolt.Tx, edgeInfo *channeldb.ChannelEdgeInfo, outEdge,
...
func findPath(g *graphParams, r *RestrictParams, cfg *PathFindingConfig,
	source, target route.Vertex, amt lnwire.MilliAtom, finalHtlcExpiry int32) (
	[]*channeldb.ChannelEdgePolicy, error) {
