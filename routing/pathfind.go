...
// edgePolicyWithSource is a helper struct to keep track of the source node of
// a channel edge. ChannelEdgePolicy only contains to destination node of the
// edge.
...
func findPath(g *graphParams, r *RestrictParams, source, target route.Vertex,
	...
	processEdge := func(fromNode *channeldb.LightningNode,
		edge *channeldb.ChannelEdgePolicy,
		bandwidth lnwire.MilliAtom, toNode route.Vertex) {
