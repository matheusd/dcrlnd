...
func (m *mockPaymentSessionOld) RequestRoute(_, _ lnwire.MilliAtom,
...
func (m *mockPaymentSessionOld) UpdateAdditionalEdge(_ *lnwire.ChannelUpdate,
	_ *secp256k1.PublicKey, _ *channeldb.CachedEdgePolicy) bool {

	return false
}

func (m *mockPaymentSessionOld) GetAdditionalEdgePolicy(_ *secp256k1.PublicKey,
...
func (m *mockPaymentSession) RequestRoute(maxAmt, feeLimit lnwire.MilliAtom,
...
func (m *mockPaymentSession) GetAdditionalEdgePolicy(pubKey *secp256k1.PublicKey,
...
func (m *mockLink) Bandwidth() lnwire.MilliAtom {
	return m.bandwidth
}
...
func (m *mockLink) MayAddOutgoingHtlc(_ lnwire.MilliAtom) error {
