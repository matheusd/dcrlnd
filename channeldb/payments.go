...
// FetchPaymentStatus returns the payment status for outgoing payment.  If
// status of the payment isn't found, it will default to "StatusGrounded".
//
// NOTE: Deprecated. Kept around for migration purposes.
...
func deserializeOutgoingPayment(r io.Reader) (*OutgoingPayment, error) {
	...
	p.Fee = lnwire.MilliAtom(byteOrder.Uint64(scratch[:]))
