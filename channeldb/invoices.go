...
// AcceptOrSettleInvoice attempts to mark an invoice corresponding to the
// passed payment hash as settled. If an invoice matching the passed payment
...
func settleHoldInvoice(invoices, settleIndex *bolt.Bucket,
...
func cancelInvoice(invoices *bolt.Bucket, invoiceNum []byte) (
	*Invoice, error) {
