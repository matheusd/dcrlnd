...
import bbolt "go.etcd.io/bbbolt"
...
var (
	...
	// dbVersionKey is a bboltdb key and it's used for storing/retrieving
...
// FetchMeta fetches the meta data from bboltdb and returns filled meta
// structure.
