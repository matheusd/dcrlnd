...
func fetchChanBucket(tx kvdb.ReadTx, nodeKey *secp256k1.PublicKey,
...
func fetchChanBucketRw(tx kvdb.RwTx, nodeKey *secp256k1.PublicKey,
...
// the channel.
func (c *OpenChannel) MarkDataLoss(commitPoint *secp256k1.PublicKey) error {
	c.Lock()
	defer c.Unlock()
...
// anchor outputs.
func (c *OpenChannel) BalancesAtHeight(height uint64) (lnwire.MilliAtom,
