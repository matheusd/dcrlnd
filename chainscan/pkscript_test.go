...
func TestComputePkScript(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "P2PKH sigScript with smaller sig",
			sigScript: []byte{
				// OP_DATA_69
				0x45,
				// <69-byte-sig>
				0x30, 0x42, 0x2, 0x1f, 0x4, 0x9, 0x38, 0x43,
				0x27, 0x29, 0x24, 0x6f, 0x30, 0x1a, 0x67, 0x65,
				0x4, 0x34, 0xb4, 0x27, 0xaa, 0x5c, 0x3a, 0x28,
				0x36, 0xa3, 0x70, 0x6, 0xd5, 0xf0, 0x26, 0x97,
				0xb1, 0x63, 0x10, 0x2, 0x1f, 0xe, 0xbf, 0xe0,
				0x83, 0xcf, 0x50, 0xfe, 0xdf, 0xec, 0x62, 0x7f,
				0x82, 0x58, 0xf0, 0x20, 0xe3, 0x5d, 0xb, 0xf8,
				0x8a, 0x60, 0xb0, 0x37, 0x70, 0x8b, 0x33, 0xa1,
				0xb3, 0xab, 0xcf, 0x9f, 0x1,
				// OP_DATA_33
				0x21,
				// <33-byte-compressed pubkey>
				0x3, 0xc9, 0x38, 0xac, 0xde, 0x89, 0x9e, 0x70,
				0x80, 0xad, 0x60, 0xd3, 0x7, 0xe6, 0x75, 0xf,
				0xd, 0xb9, 0x68, 0xed, 0x5d, 0xca, 0x32, 0x38,
			...
			pkScript: []byte{
				...
				0x14,
				// <20-byte pubkey hash>
				0x96, 0x49, 0xeb, 0xb1, 0x5e, 0x79, 0xa4, 0xa0,
				0x6b, 0x39, 0x53, 0xc3, 0x9b, 0x36, 0x49, 0xcf,
				0xeb, 0xb8, 0xe4, 0xe9,
				// OP_EQUALVERIFY
				0x88,
				// OP_CHECKSIG
		...
		{
			name: "P2PKH sigScript with smallest sig",
			sigScript: []byte{
				// OP_DATA_08
				0x08,
				// <69-byte-sig>
