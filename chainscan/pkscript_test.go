	...
	tests := []struct {
		...
		},
		{
			...
			sigScript: []byte{
				...
				0x46,
				// <70-byte sig>
				0x30, 0x43, 0x2, 0x20, 0x20, 0xf7, 0x0, 0xba,
				0xce, 0xcc, 0xf3, 0x7e, 0xfe, 0x82, 0x98, 0xce,
				0x73, 0xaf, 0x4, 0xca, 0x69, 0x13, 0x2a, 0xe8,
				0xd6, 0xc9, 0xd5, 0x16, 0xf2, 0x5c, 0x33, 0xa7,
				0x34, 0xf1, 0x2e, 0xa0, 0x2, 0x1f, 0x3b, 0x69,
				0xa7, 0x8d, 0x96, 0xc, 0xae, 0x3f, 0x21, 0x74,
				0xab, 0x11, 0x8e, 0x8d, 0xfe, 0xfd, 0xe9, 0x4,
				0xfd, 0x16, 0x79, 0x2d, 0x67, 0xaa, 0xe4, 0xf4,
				0x97, 0xd1, 0xa9, 0x2c, 0xca, 0x1,
				// OP_DATA_33
				0x21,
				// <33-byte compressed pubkey>
				0x3, 0x84, 0xbb, 0x11, 0xa, 0x17, 0xa0, 0xfa,
				0xcf, 0x17, 0xa1, 0x16, 0x19, 0xdd, 0xb4, 0xfb,
				0x98, 0xb4, 0x74, 0x8f, 0xc5, 0xf4, 0xe1, 0x4d,
				0x41, 0xc4, 0xe9, 0x62, 0x15, 0xc6, 0x86, 0x68,
				0x47,
			},
			class: txscript.PubKeyHashTy,
			pkScript: []byte{
				...
				0x14,
				// <20-byte pubkey hash>
				0x67, 0x30, 0xef, 0x89, 0xed, 0x30, 0x3a, 0x03,
				0xca, 0x22, 0x56, 0x9f, 0x17, 0x4a, 0x90, 0x93,
				0x6d, 0x46, 0xf9, 0x8e,
				// OP_EQUALVERIFY
				0x88,
				// OP_CHECKSIG
		...
		{
			// Looks like a p2pkh but the pubkey is invalid.
			name: "P2SH with invalid pubkey",
			sigScript: []byte{
				// OP_DATA_70,
				0x46,
				// <70-byte sig>
				...
				0x21,
				// <33-byte compressed pubkey>
				0x00, 0x84, 0xbb, 0x11, 0xa, 0x17, 0xa0, 0xfa,
				0xcf, 0x17, 0xa1, 0x16, 0x19, 0xdd, 0xb4, 0xfb,
				0x98, 0xb4, 0x74, 0x8f, 0xc5, 0xf4, 0xe1, 0x4d,
				0x41, 0xc4, 0xe9, 0x62, 0x15, 0xc6, 0x86, 0x68,
				0x47,
			...
			pkScript: []byte{
				...
				0x14,
				// <20-byte pubkey hash>
				0xa6, 0xcc, 0x68, 0x6d, 0x3f, 0xca, 0x65, 0x60,
				0x68, 0x2f, 0xb6, 0x14, 0x03, 0x98, 0x6c, 0x70,
				0x02, 0x0f, 0xa8, 0xa9,
				// OP_EQUAL
				0x87,
			},
